autoCond = {
    ...
    'run2_design'       :   '106X_mcRun2_design_PFCalibration_v1',
    ...
    'run1_data'         :   '106X_dataRun2_PFCalibration_v1',
    # GlobalTag for Run2 data reprocessing
    'run2_data'         :   '106X_dataRun2_PFCalibration_v1',
    # GlobalTag for Run2 data relvals: allows customization to run with fixed L1 menu
    'run2_data_relval'  :   '106X_dataRun2_relval_PFCalibration_v1',
    # GlobalTag for Run2 data 2018B relvals only: HEM-15-16 fail
    'run2_data_promptlike_HEfail' : '106X_dataRun2_PromptLike_HEfail_PFCalibration_v1',
    ...
    'phase1_2017_design'       :  '106X_mc2017_design_IdealBS_PFcalibration_v1',
    # GlobalTag for MC production with realistic conditions for Phase1 2017 detector
    'phase1_2017_realistic'    :  '106X_mc2017_realistic_PFCalibration_v1',
    ...
    'phase1_2018_design'       :  '106X_upgrade2018_design_PFCalibration_v1',
    # GlobalTag for MC production with realistic conditions for full Phase1 2018 detector
    'phase1_2018_realistic'    :  '106X_upgrade2018_realistic_PFCalibration_v1',
    # GlobalTag for MC production with realistic conditions for full Phase1 2018 detector for Heavy Ion
    'phase1_2018_realistic_hi' :  '106X_upgrade2018_realistic_HI_v2',
    # GlobalTag for MC production with realistic conditions for full Phase1 2018 detector: HEM-15-16 fail
    'phase1_2018_realistic_HEfail' :  '106X_upgrade2018_realistic_HEfail_PFCalibration_v1',
    # GlobalTag for MC production (cosmics) with realistic conditions for full Phase1 2018 detector,  Strip tracker in DECO mode
    'phase1_2018_cosmics'      :   '106X_upgrade2018cosmics_realistic_deco_PFCalibration_v1',
    # GlobalTag for MC production (cosmics) with realistic conditions for full Phase1 2018 detector,  Strip tracker in PEAK mode
    'phase1_2018_cosmics_peak' :   '106X_upgrade2018cosmics_realistic_peak_PFCalibration_v1',
    # GlobalTag for MC production with perfectly aligned and calibrated detector for Phase1 2019
    'phase1_2019_design'       : '106X_postLS2_design_PFCalibration_v1', # GT containing design conditions for postLS2
    # GlobalTag for MC production with realistic conditions for Phase1 2019
    'phase1_2019_realistic'    : '106X_postLS2_realistic_PFCalibration_v1', # GT containing realistic conditions for postLS2
