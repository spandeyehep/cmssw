...
void calcThickness(string inputFile_name){
  ...
  */
  ...
  map<int, vector<float> > line_el {
    {0, {8, 4, 5, 4, 7, 7, 7, 2, 6, 2, 7, 7, 7}},
      {1, {4, 5, 4, 7, 7, 7, 2, 6, 2, 7, 7, 7}},
	{2, {4, 5, 4, 7, 7, 7, 2, 6, 2, 7, 7, 7}},
	  {3, {4, 5, 4, 7, 7, 7, 2, 6, 2, 7, 7, 7}},
	    {4, {4, 5, 4, 7, 7, 7, 2, 6, 2, 7, 7, 7}},
	      {5, {4, 5, 4, 7, 7, 7, 2, 6, 2, 7, 7, 7}},
		{6, {4, 5, 4, 7, 7, 7, 2, 6, 2, 7, 7, 7}},
		  {7, {4, 5, 4, 7, 7, 7, 3, 2, 6, 2, 3, 7, 7, 7}},
		    {8, {4, 5, 4, 7, 7, 7, 2, 6, 2, 7, 7, 7}},
		      {9, {4, 5, 4, 7, 7, 7, 3, 2, 6, 2, 3, 7, 7, 7}},
			{10, {4, 5, 4, 7, 7, 7, 2, 6, 2, 7, 7, 7}},
			  {11, {4, 5, 4, 7, 7, 7, 3, 2, 6, 2, 7, 7, 7}},
			    {12, {4, 5, 4, 7, 7, 7, 2, 6, 2, 7, 7, 7}},
			      {13, {4, 5, 4, 7, 7, 7, 2, 6, 2, 7, 7, 7}},
				{14, {8}},
		      };
