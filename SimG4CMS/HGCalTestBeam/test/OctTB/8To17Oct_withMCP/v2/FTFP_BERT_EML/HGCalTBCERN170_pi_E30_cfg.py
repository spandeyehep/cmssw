...
process.generator = cms.EDProducer("GaussRandomPThetaGunProducer",
    ...
    PGunParameters = cms.PSet(
		...
		MeanP    = cms.double(30),
		SigmaP   = cms.double(.090),
		
		MinTheta = cms.double(.012001),
		MaxTheta = cms.double(.012001),
		MinPhi = cms.double(3.641493),
		MaxPhi = cms.double(3.641493),
...
process.VtxSmeared.MeanX  = 34.278623
process.VtxSmeared.SigmaX = 1.091
process.VtxSmeared.MeanY  = 20.452299
process.VtxSmeared.SigmaY = 1.161
