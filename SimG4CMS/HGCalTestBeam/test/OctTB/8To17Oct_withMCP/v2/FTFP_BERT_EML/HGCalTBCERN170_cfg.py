...
process.generator = cms.EDProducer("GaussRandomPThetaGunProducer",
    ...
    PGunParameters = cms.PSet(
		...
		MinTheta = cms.double(THETA),
		MaxTheta = cms.double(THETA),
		MinPhi = cms.double(PHI),
		MaxPhi = cms.double(PHI),
...
process.VtxSmeared.MeanX  = BEAMX
process.VtxSmeared.SigmaX = BEAMSX
process.VtxSmeared.MeanY  = BEAMY
process.VtxSmeared.SigmaY = BEAMSY
