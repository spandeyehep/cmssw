...
config.General.requestName = 'HGCalTB_sim_pion200_HadInt_7'
...
config.Data.outLFNDirBase = '/store/user/spandey/HGCAL/simulation_v2/HadronicInt/HGCalTB_sim_pion200/'
