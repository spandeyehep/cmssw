...
process.generator = cms.EDProducer("GaussRandomPThetaGunProducer",
    ...
    PGunParameters = cms.PSet(
		...
		MinTheta = cms.double(.012128),
		MaxTheta = cms.double(.012128),
		MinPhi = cms.double(3.636328),
		MaxPhi = cms.double(3.636328),
...
process.VtxSmeared.MeanX  = 33.915978
process.VtxSmeared.SigmaX = .944066
process.VtxSmeared.MeanY  = 20.867345
process.VtxSmeared.SigmaY = .767335
