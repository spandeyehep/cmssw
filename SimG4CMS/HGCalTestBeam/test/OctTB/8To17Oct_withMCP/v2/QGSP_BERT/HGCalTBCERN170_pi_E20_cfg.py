...
process.generator = cms.EDProducer("GaussRandomPThetaGunProducer",
    ...
    PGunParameters = cms.PSet(
		...
		MeanP    = cms.double(20),
		SigmaP   = cms.double(.177),
		
		MinTheta = cms.double(.011619),
		MaxTheta = cms.double(.011619),
		MinPhi = cms.double(3.659799),
		MaxPhi = cms.double(3.659799),
...
process.VtxSmeared.MeanX  = 32.792465
process.VtxSmeared.SigmaX = 1.29778
process.VtxSmeared.MeanY  = 20.025798
