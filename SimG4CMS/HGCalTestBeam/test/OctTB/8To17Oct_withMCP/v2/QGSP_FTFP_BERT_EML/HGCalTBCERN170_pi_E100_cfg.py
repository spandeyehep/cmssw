...
process.generator = cms.EDProducer("GaussRandomPThetaGunProducer",
    ...
    PGunParameters = cms.PSet(
		...
		MeanP    = cms.double(100),
		SigmaP   = cms.double(.100),
		
		MinTheta = cms.double(.012139),
		MaxTheta = cms.double(.012139),
		MinPhi = cms.double(3.635932),
		MaxPhi = cms.double(3.635932),
...
process.VtxSmeared.MeanX  = 33.861249
process.VtxSmeared.SigmaX = .881709
process.VtxSmeared.MeanY  = 20.796806
process.VtxSmeared.SigmaY = .664649
