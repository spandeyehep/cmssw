...
config.General.requestName = 'HGCalTB_sim_electron100'
...
#config.JobType.psetName = 'SinglePiE100HCAL_pythia8_cfi_GEN_SIM.py'
config.JobType.psetName = 'HGCalTBCERN170_elec_E100_cfg.py'
config.JobType.outputFiles = ['TBGenSim.root']
config.JobType.eventsPerLumi = 2000

config.section_("Data")
#config.Data.inputDataset = '/Single_Electron_gun_13TeV_pythia8/Fall14DR73-NoPU_MCRUN2_73_V9-v1/GEN-SIM-RAW-RECO'
...
config.Data.outLFNDirBase = '/store/user/spandey/HGCAL/simulation_v3/QGSP_FTFP_BERT_EML/HGCalTB_sim_electron100/'
