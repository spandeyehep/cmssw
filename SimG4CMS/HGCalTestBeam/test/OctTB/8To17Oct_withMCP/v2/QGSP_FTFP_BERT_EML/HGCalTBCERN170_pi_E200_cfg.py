...
process.generator = cms.EDProducer("GaussRandomPThetaGunProducer",
    ...
    PGunParameters = cms.PSet(
		...
		MeanP    = cms.double(200),
		SigmaP   = cms.double(.201),
		
		MinTheta = cms.double(.012179),
		MaxTheta = cms.double(.012179),
		MinPhi = cms.double(3.641316),
		MaxPhi = cms.double(3.641316),
...
process.VtxSmeared.MeanX  = 33.137400
process.VtxSmeared.SigmaX = .375787
process.VtxSmeared.MeanY  = 20.560352
process.VtxSmeared.SigmaY = .408783
...
process.g4SimHits.Physics.type = cms.string('SimG4Core/Physics/QGSP_FTFP_BERT_EML')
