...
process.load('SimG4CMS.HGCalTestBeam.HGCalTB181Oct8To17XML_cfi')
...
process.generator = cms.EDProducer("FlatRandomEThetaGunProducer",
    ...
    PGunParameters = cms.PSet(
        MinE = cms.double(149.99),
        MaxE = cms.double(150.01),
...
process.VtxSmeared.MeanX  = -.219
process.VtxSmeared.SigmaX = .747
process.VtxSmeared.MeanY  = -.525
process.VtxSmeared.SigmaY = .645
