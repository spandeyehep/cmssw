...
process.generator = cms.EDProducer("GaussRandomPThetaGunProducer",
    ...
    PGunParameters = cms.PSet(
		...
		MeanP    = cms.double(300),
		SigmaP   = cms.double(.302),
		
		MinTheta = cms.double(.012223),
		MaxTheta = cms.double(.012223),
		MinPhi = cms.double(3.645796),
		MaxPhi = cms.double(3.645796),
...
process.VtxSmeared.MeanX  = 33.216112
process.VtxSmeared.SigmaX = .44284
process.VtxSmeared.MeanY  = 20.310643
process.VtxSmeared.SigmaY = .358179
