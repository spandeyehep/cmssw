...
config.General.requestName = 'HGCalTB_sim_muon200'
...
#config.JobType.psetName = 'SingleMuE50HCAL_pythia8_cfi_GEN_SIM.py'
...
#config.Data.inputDataset = '/Single_Muon_gun_13TeV_pythia8/Fall14DR73-NoPU_MCRUN2_73_V9-v1/GEN-SIM-RAW-RECO'
...
config.Data.outLFNDirBase = '/store/user/spandey/HGCAL/simulation_v3/QGSP_FTFP_BERT_EML/HGCalTB_sim_muon200/'
