...
config.General.requestName = 'HGCalTB_sim_electron20'
...
config.JobType.psetName = 'HGCalTBCERN170_elec_E20_cfg.py'
...
config.Data.outLFNDirBase = '/store/user/spandey/HGCAL/simulation_v3/QGSP_FTFP_BERT_EML/HGCalTB_sim_electron20/'
