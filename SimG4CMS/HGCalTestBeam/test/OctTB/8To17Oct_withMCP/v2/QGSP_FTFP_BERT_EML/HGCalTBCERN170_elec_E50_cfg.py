...
process.generator = cms.EDProducer("GaussRandomPThetaGunProducer",
    ...
    PGunParameters = cms.PSet(
		...
		MeanP    = cms.double(50),
		SigmaP   = cms.double(.080),
		
		MinTheta = cms.double(.012071),
		MaxTheta = cms.double(.012071),
		MinPhi = cms.double(3.637457),
		MaxPhi = cms.double(3.637457),
...
process.VtxSmeared.MeanX  = 33.846409
process.VtxSmeared.SigmaX = 1.05242
process.VtxSmeared.MeanY  = 20.659685
process.VtxSmeared.SigmaY = .942595
