...
process.generator = cms.EDProducer("GaussRandomPThetaGunProducer",
    ...
    PGunParameters = cms.PSet(
		...
		MeanP    = cms.double(250),
		SigmaP   = cms.double(.252),
		
		MinTheta = cms.double(.012234),
		MaxTheta = cms.double(.012234),
		MinPhi = cms.double(3.643557),
		MaxPhi = cms.double(3.643557),
...
process.VtxSmeared.MeanX  = 33.451364
process.VtxSmeared.SigmaX = .529465
process.VtxSmeared.MeanY  = 20.424566
process.VtxSmeared.SigmaY = .353722
