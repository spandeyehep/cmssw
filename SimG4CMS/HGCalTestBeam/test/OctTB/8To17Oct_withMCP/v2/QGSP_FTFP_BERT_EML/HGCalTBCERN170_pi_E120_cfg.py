...
process.generator = cms.EDProducer("GaussRandomPThetaGunProducer",
    ...
    PGunParameters = cms.PSet(
		...
		MeanP    = cms.double(120),
		SigmaP   = cms.double(.096),
		
		MinTheta = cms.double(.012171),
		MaxTheta = cms.double(.012171),
		MinPhi = cms.double(3.637448),
		MaxPhi = cms.double(3.637448),
...
process.VtxSmeared.MeanX  = 33.819573
process.VtxSmeared.SigmaX = .815115
process.VtxSmeared.MeanY  = 20.671064
process.VtxSmeared.SigmaY = .5469
