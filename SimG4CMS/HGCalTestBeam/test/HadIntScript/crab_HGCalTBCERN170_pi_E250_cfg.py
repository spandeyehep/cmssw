...
config.General.requestName = 'HGCalTB_sim_pion250_nSec_resub_resub'
...
#config.JobType.psetName = 'SinglePiE250HCAL_pythia8_cfi_GEN_SIM.py'
config.JobType.psetName = 'HGCalTBCERN170_pi_E250_cfg_WITH_HadInt_info.py'
...
config.Data.outLFNDirBase = '/store/user/spandey/HGCAL/simulation_v2/HadInt/HGCalTB_sim_pion250_nSec_resub_resub/'
