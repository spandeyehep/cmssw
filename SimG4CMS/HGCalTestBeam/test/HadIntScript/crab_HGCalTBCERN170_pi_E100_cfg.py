...
config.General.requestName = 'HGCalTB_sim_pion100_nSec'
...
config.JobType.psetName = 'HGCalTBCERN170_pi_E100_cfg_WITH_HadInt_info.py'
...
config.Data.outLFNDirBase = '/store/user/spandey/HGCAL/simulation_v2/HadInt/HGCalTB_sim_pion100_nSec/'
